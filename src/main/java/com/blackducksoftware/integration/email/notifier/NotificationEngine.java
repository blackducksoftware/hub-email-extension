...
public class NotificationEngine {
	...
	@Autowired
	private ItemRouter<EmailSystemProperties, List<NotificationItem>, Map<String, Object>>[] routerArray;

	@PostConstruct
	public void configure() {
		if (routerArray != null) {
			for (final ItemRouter<EmailSystemProperties, List<NotificationItem>, Map<String, Object>> router : routerArray) {

...
@Component
public class PolicyViolationOverrideCancelRouter extends AbstractEmailRouter {

	private final static Logger logger = LoggerFactory.getLogger(PolicyViolationOverrideCancelRouter.class);
